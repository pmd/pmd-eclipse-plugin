...
public class UniqueItemsAsShapeBuilder extends AbstractCellPainterBuilder {
    ...
    public UniqueItemsAsShapeBuilder(int theWidth, int theHeight, int horizAlignment,
            Map<Object, ShapeDescriptor> theShapesByItem) {
        width = theWidth;
        height = theHeight;
        ...
        Listener paintListener = new Listener() {
            ...
            public void handleEvent(Event event) {
                ...
                for (int i = 0; i < shapes.size(); i++) {
                    ...
                    ShapePainter.drawShape(width, height, shape.shape, gc, event.x + xOffset, event.y + verticalOffset,
                            null);
                }
