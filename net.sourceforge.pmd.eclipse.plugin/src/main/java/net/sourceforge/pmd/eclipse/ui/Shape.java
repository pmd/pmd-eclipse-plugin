...
public enum Shape {
    ...
    plus(
            20,
            "Plus",
            new float[] { 0.333f, 0, 0.666f, 0, 0.666f, 0.333f, 1, 0.333f, 1, 0.666f, 0.666f, 0.666f, 0.666f, 1, 0.333f,
                1, 0.333f, 0.666f, 0, 0.666f, 0, 0.333f, 0.333f, 0.333f }),
    star(
            21,
            "Star",
            new float[] { 0.500f, 1.000f, 0.378f, 0.619f, 0, 0.619f, 0.303f, 0.381f, 0.193f, 0, 0.500f, 0.226f, 0.807f,
                0, 0.697f, 0.381f, 1.000f, 0.619f, 0.622f, 0.619f });

    public final int id;
    public final String label;
    private final float[] polyPoints;

    Shape(int theId, String theLabel) {
        this(theId, theLabel, null);
    }

    Shape(int theId, String theLabel, float[] optionalPolygonPoints) {
        id = theId;
        label = theLabel;
