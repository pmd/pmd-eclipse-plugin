...
public class StyleExtractor {
    ...
    public void refreshMultilineComments(String text) {
        ...
        if (syntaxData != null) {
            ...
            int pos = text.indexOf(syntaxData.getMultiLineCommentStart());
            while (pos > -1) {
                ...
                // next comment
                pos = text.indexOf(syntaxData.getMultiLineCommentStart(), pos);
            }
        }
    }
    ...
    public List<StyleRange> lineStylesFor(String lineText, int lineOffset, int length) {
        ...
        while (start < length) {
            ...
            if (atMultiLineCommentStart(lineText, start)) {
                ...
                int kwEnd = getKeywordEnd(lineText, start); 
