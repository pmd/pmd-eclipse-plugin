...
/**
 * Data Class for storing an Element as well as SWT-Values, that determine how
 * to show the Element (centered, left and so on)
 * 
...
public class DataflowGraphTableData {
     ...
     *            the Data to show
     * @param style,
     *            the SWT-Style, how to show the Element
     */
