...
### 📦 Dependency updates
* [#407](https://github.com/pmd/pmd-eclipse-plugin/pull/407): Bump org.apache.maven.plugins:maven-dependency-plugin from 3.10.0 to 3.11.0
* [#408](https://github.com/pmd/pmd-eclipse-plugin/pull/408): Bump ch.qos.logback:logback-classic from 1.5.32 to 1.5.34
* [#409](https://github.com/pmd/pmd-eclipse-plugin/pull/409): Bump com.puppycrawl.tools:checkstyle from 13.4.2 to 13.5.0
* [#410](https://github.com/pmd/pmd-eclipse-plugin/pull/410): Bump org.apache.maven.plugins:maven-failsafe-plugin from 3.5.5 to 3.5.6
* [#411](https://github.com/pmd/pmd-eclipse-plugin/pull/411): Bump com.sun.xml.bind:jaxb-impl from 4.0.8 to 4.0.9
* [#412](https://github.com/pmd/pmd-eclipse-plugin/pull/412): Bump org.apache.maven.plugins:maven-surefire-plugin from 3.5.5 to 3.5.6
* [#413](https://github.com/pmd/pmd-eclipse-plugin/pull/413): Bump actions/checkout from 6.0.2 to 6.0.3
* [#414](https://github.com/pmd/pmd-eclipse-plugin/pull/414): Bump net.sourceforge.pmd:pmd-build-tools-config from 38 to 39
* [#415](https://github.com/pmd/pmd-eclipse-plugin/pull/415): Bump com.puppycrawl.tools:checkstyle from 13.5.0 to 13.6.0
* [#416](https://github.com/pmd/pmd-eclipse-plugin/pull/416): Bump actions/setup-java from 5.2.0 to 5.3.0
* [#417](https://github.com/pmd/pmd-eclipse-plugin/pull/417): Bump actions/setup-java from 5.2.0 to 5.3.0 in /.github/actions/setup
* [#418](https://github.com/pmd/pmd-eclipse-plugin/pull/418): Bump actions/cache from 5.0.5 to 6.0.0
* [#419](https://github.com/pmd/pmd-eclipse-plugin/pull/419): Bump actions/checkout from 6.0.3 to 7.0.0
* [#420](https://github.com/pmd/pmd-eclipse-plugin/pull/420): Bump actions/cache from 5.0.5 to 6.0.0 in /.github/actions/setup
* [#421](https://github.com/pmd/pmd-eclipse-plugin/pull/421): Bump ch.qos.logback:logback-classic from 1.5.34 to 1.5.35
* [#423](https://github.com/pmd/pmd-eclipse-plugin/pull/423): Bump PMD from 7.25.0 to 7.26.0
...
### 🚀 New and noteworthy
* Update to PMD 7.24.0

### 📦 Dependency updates
* [#386](https://github.com/pmd/pmd-eclipse-plugin/pull/386): chore: Update dependabot config to consider custom setup action
* [#387](https://github.com/pmd/pmd-eclipse-plugin/pull/387): Bump actions/setup-java from 4.7.1 to 5.2.0 in /.github/actions/setup
* [#388](https://github.com/pmd/pmd-eclipse-plugin/pull/388): Bump actions/cache from 4.2.4 to 5.0.4 in /.github/actions/setup
* [#389](https://github.com/pmd/pmd-eclipse-plugin/pull/389): Bump com.puppycrawl.tools:checkstyle from 13.3.0 to 13.4.0
* [#390](https://github.com/pmd/pmd-eclipse-plugin/pull/390): Bump com.github.siom79.japicmp:japicmp-maven-plugin from 0.25.4 to 0.25.5
* [#391](https://github.com/pmd/pmd-eclipse-plugin/pull/391): Bump actions/cache from 5.0.4 to 5.0.5
* [#392](https://github.com/pmd/pmd-eclipse-plugin/pull/392): Bump actions/upload-artifact from 7.0.0 to 7.0.1
* [#393](https://github.com/pmd/pmd-eclipse-plugin/pull/393): Bump actions/create-github-app-token from 3.0.0 to 3.1.1
* [#394](https://github.com/pmd/pmd-eclipse-plugin/pull/394): Bump actions/cache from 5.0.4 to 5.0.5 in /.github/actions/setup
* [#395](https://github.com/pmd/pmd-eclipse-plugin/pull/395): Bump com.github.siom79.japicmp:japicmp-maven-plugin from 0.25.5 to 0.25.6
* [#396](https://github.com/pmd/pmd-eclipse-plugin/pull/396): Bump PMD from 7.23.0 to 7.24.0

## 27-March-2026: 7.23.0.v20260327-1136-r

This is a minor release.

### 🚀 New and noteworthy
* Update to PMD 7.23.0
* Support for Eclipse 2026-03 added
* Support for Eclipse 2025-03 removed

### ✨ Merged pull requests
* [#381](https://github.com/pmd/pmd-eclipse-plugin/pull/381): Support eclipse 2026-03 - [Andreas Dangel](https://github.com/adangel) (@adangel)

### 📦 Dependency updates
* [#366](https://github.com/pmd/pmd-eclipse-plugin/pull/366): Bump slf4j from 1.7.36 to 2.0.17
* [#372](https://github.com/pmd/pmd-eclipse-plugin/pull/372): Bump com.puppycrawl.tools:checkstyle from 13.2.0 to 13.3.0
* [#373](https://github.com/pmd/pmd-eclipse-plugin/pull/373): Bump actions/download-artifact from 7.0.0 to 8.0.0
* [#374](https://github.com/pmd/pmd-eclipse-plugin/pull/374): Bump actions/upload-artifact from 6.0.0 to 7.0.0
* [#375](https://github.com/pmd/pmd-eclipse-plugin/pull/375): Bump org.apache.maven.plugins:maven-resources-plugin from 3.4.0 to 3.5.0
* [#378](https://github.com/pmd/pmd-eclipse-plugin/pull/378): Bump actions/create-github-app-token from 2.2.1 to 3.0.0
* [#379](https://github.com/pmd/pmd-eclipse-plugin/pull/379): Bump actions/download-artifact from 8.0.0 to 8.0.1
* [#380](https://github.com/pmd/pmd-eclipse-plugin/pull/380): Bump jaxb from 2.3.1 to 4.0.7
* [#382](https://github.com/pmd/pmd-eclipse-plugin/pull/382): Bump jakarta.xml.bind:jakarta.xml.bind-api from 4.0.2 to 4.0.5
* [#383](https://github.com/pmd/pmd-eclipse-plugin/pull/383): Bump actions/cache from 5.0.3 to 5.0.4
* [#384](https://github.com/pmd/pmd-eclipse-plugin/pull/384): Bump maven from 3.9.12 to 3.9.14
* [#385](https://github.com/pmd/pmd-eclipse-plugin/pull/385): Bump PMD from 7.22.0 to 7.23.0
...
### 📦 Dependency updates
* [#333](https://github.com/pmd/pmd-eclipse-plugin/pull/333): Bump org.apache.maven.plugins:maven-resources-plugin from 3.3.1 to 3.4.0
* [#334](https://github.com/pmd/pmd-eclipse-plugin/pull/334): Bump com.puppycrawl.tools:checkstyle from 12.1.2 to 12.2.0
* [#335](https://github.com/pmd/pmd-eclipse-plugin/pull/335): Bump actions/checkout from 6.0.0 to 6.0.1
* [#336](https://github.com/pmd/pmd-eclipse-plugin/pull/336): Bump actions/setup-java from 5.0.0 to 5.1.0
* [#337](https://github.com/pmd/pmd-eclipse-plugin/pull/337): Bump actions/create-github-app-token from 2.2.0 to 2.2.1
* [#339](https://github.com/pmd/pmd-eclipse-plugin/pull/339): Bump com.puppycrawl.tools:checkstyle from 12.2.0 to 12.3.0
* [#341](https://github.com/pmd/pmd-eclipse-plugin/pull/341): Bump actions/cache from 4.3.0 to 5.0.1
* [#342](https://github.com/pmd/pmd-eclipse-plugin/pull/342): Bump actions/upload-artifact from 5.0.0 to 6.0.0
...
### 📦 Dependency updates
* [#302](https://github.com/pmd/pmd-eclipse-plugin/pull/302): Bump org.apache.maven.plugins:maven-surefire-plugin from 3.5.3 to 3.5.4
* [#303](https://github.com/pmd/pmd-eclipse-plugin/pull/303): Bump org.apache.maven.plugins:maven-failsafe-plugin from 3.5.3 to 3.5.4
* [#304](https://github.com/pmd/pmd-eclipse-plugin/pull/304): Bump actions/create-github-app-token from 2.1.1 to 2.1.4
* [#307](https://github.com/pmd/pmd-eclipse-plugin/pull/307): Bump com.puppycrawl.tools:checkstyle from 10.26.1 to 11.1.0
* [#309](https://github.com/pmd/pmd-eclipse-plugin/pull/309): Bump actions/cache from 4.2.4 to 4.3.0
* [#310](https://github.com/pmd/pmd-eclipse-plugin/pull/310): Bump com.github.siom79.japicmp:japicmp-maven-plugin from 0.23.1 to 0.24.1
* [#311](https://github.com/pmd/pmd-eclipse-plugin/pull/311): Bump org.apache.maven.plugins:maven-enforcer-plugin from 3.6.1 to 3.6.2
* [#312](https://github.com/pmd/pmd-eclipse-plugin/pull/312): Bump org.apache.maven.plugins:maven-dependency-plugin from 3.8.1 to 3.9.0
* [#313](https://github.com/pmd/pmd-eclipse-plugin/pull/313): Bump org.apache.maven.plugins:maven-pmd-plugin from 3.27.0 to 3.28.0
* [#314](https://github.com/pmd/pmd-eclipse-plugin/pull/314): Bump com.github.siom79.japicmp:japicmp-maven-plugin from 0.24.1 to 0.24.2
* [#315](https://github.com/pmd/pmd-eclipse-plugin/pull/315): Bump com.puppycrawl.tools:checkstyle from 11.1.0 to 12.0.1
* [#316](https://github.com/pmd/pmd-eclipse-plugin/pull/316): Bump build-tools from 34 to 35
* [#318](https://github.com/pmd/pmd-eclipse-plugin/pull/318): Bump org.apache.maven.plugins:maven-antrun-plugin from 3.1.0 to 3.2.0
* [#319](https://github.com/pmd/pmd-eclipse-plugin/pull/319): Bump com.puppycrawl.tools:checkstyle from 12.0.1 to 12.1.0
* [#320](https://github.com/pmd/pmd-eclipse-plugin/pull/320): Bump com.puppycrawl.tools:checkstyle from 12.1.0 to 12.1.1
* [#321](https://github.com/pmd/pmd-eclipse-plugin/pull/321): Bump actions/upload-artifact from 4.6.2 to 5.0.0
* [#322](https://github.com/pmd/pmd-eclipse-plugin/pull/322): Bump actions/download-artifact from 5.0.0 to 6.0.0
* [#323](https://github.com/pmd/pmd-eclipse-plugin/pull/323): Bump PMD from 7.17.0 to 7.18.0
